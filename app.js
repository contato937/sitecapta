...
(function () {
  ...
  if (form) {
    form.addEventListener('submit', function (e) {
      ...
      if (rdForm) {
        // Coletar os valores do nosso formulário
        var nome = form.querySelector('input[type="text"][placeholder*="nome"]').value;
        var email = form.querySelector('input[type="email"]').value;
        var telefone = form.querySelector('input[type="tel"]').value;
        var instituicao = form.querySelector('input[type="text"][placeholder*="institui"]').value;
        var cargo = form.querySelector('input[type="text"][placeholder*="cargo"]').value;
        var site = form.querySelector('input[type="url"]').value;
